...
@XmlType(name = "all_item_images_ReturnElement", propOrder = {"imageClassName", "imageClassNo", "imageClassSeqNo", "imageUrl", "imageText", "defaultInd"})
public class AllItemImagesReturnElement {
