...
@XmlType(name = "acct_credits_ReturnElement", propOrder = {"creditNo", "createdBy", "createdDate", "amount", "creditType", "appliedAmount", "unappliedAmount", "reasonCode", "reasonText", "transactionId", "voidTransactionId"})
