...
@XmlType(name = "", propOrder = {"errorCode", "errorMsg", "writeoffDetails"})
@XmlRootElement(name = "get_writeoff_detailsResponseElement")
public class GetWriteoffDetailsResponseElement {
