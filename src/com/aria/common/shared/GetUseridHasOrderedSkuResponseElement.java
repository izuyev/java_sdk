...
@XmlType(name = "", propOrder = {"errorCode", "errorMsg", "acctNo", "orderedInd", "billedInd", "paidInd"})
@XmlRootElement(name = "get_userid_has_ordered_skuResponseElement")
public class GetUseridHasOrderedSkuResponseElement {
