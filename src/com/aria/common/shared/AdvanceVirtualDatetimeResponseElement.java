...
@XmlType(name = "", propOrder = {"errorCode", "errorMsg", "virtualDate", "virtualTime", "systemDate", "systemTime", "currentOffsetHours"})
@XmlRootElement(name = "advance_virtual_datetimeResponseElement")
public class AdvanceVirtualDatetimeResponseElement {
