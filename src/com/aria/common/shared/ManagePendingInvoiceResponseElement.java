...
@XmlType(name = "", propOrder = {"newInvoiceNo", "collectionErrorCode", "collectionErrorMsg", "statementErrorCode", "statementErrorMsg", "procCvvResponse", "procAvsResponse", "procCavvResponse", "procStatusCode", "procStatusText", "procPaymentId", "procAuthCode", "procMerchComments", "errorCode", "errorMsg"})
@XmlRootElement(name = "manage_pending_invoiceResponseElement")
public class ManagePendingInvoiceResponseElement {
