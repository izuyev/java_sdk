...
@XmlType(name = "", propOrder = {
    "clientNo",
    "authKey","acctNo","suppPlanNo","assignmentDirective","comments","doWrite","clientReceiptId","altProrationStartDate","effectiveDate","offsetInterval","invoiceUnbilledUsage"})
