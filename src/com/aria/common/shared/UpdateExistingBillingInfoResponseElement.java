...
@XmlType(name = "", propOrder = {"errorCode", "errorMsg", "collectionErrorCode", "collectionErrorMsg", "procCvvResponse", "procAvsResponse", "procCavvResponse", "procStatusCode", "procStatusText", "procPaymentId", "procAuthCode", "procMerchComments"})
@XmlRootElement(name = "update_existing_billing_infoResponseElement")
public class UpdateExistingBillingInfoResponseElement {
