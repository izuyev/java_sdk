...
@XmlType(name = "surcharges_all_ReturnElement", propOrder = {"surchargeNo", "surchargeName", "clientSurchargeId", "description", "extDescription", "surchargeType", "currency", "taxGroup", "invoiceAppMethod", "revGlCode", "arGlCode", "surchargeRate"})
public class SurchargesAllReturnElement {
