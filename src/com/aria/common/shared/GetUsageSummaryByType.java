...
@XmlType(name = "", propOrder = {
    "clientNo",
    "authKey","acctNo","userId","usageTypeFilter","dateFilterStartDate","dateFilterStartTime","dateFilterEndDate","dateFilterEndTime","billedFilter","billingPeriodFlag","usageQualifier1","usageQualifier2","usageQualifier3","usageQualifier4"})
