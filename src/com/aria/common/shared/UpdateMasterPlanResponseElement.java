...
@XmlType(name = "", propOrder = {"errorCode", "errorMsg", "prorationResultAmount", "collectionErrorCode", "collectionErrorMsg", "statementErrorCode", "statementErrorMsg", "procCvvResponse", "procAvsResponse", "procCavvResponse", "procStatusCode", "procStatusText", "procPaymentId", "procAuthCode", "procMerchComments", "invoiceNo", "cancelledSuppPlans", "expectdActivationFee", "expectdMthlyRecurringCost", "expectdAnnuRecurringCost", "updAcctInvoiceLineItems", "totalChargesBeforeTax", "totalTaxCharges", "totalChargesAfterTax", "totalCredit", "totalTaxCredit", "totalCreditBeforeTax", "total", "thirdPartyErrors"})
@XmlRootElement(name = "update_master_planResponseElement")
public class UpdateMasterPlanResponseElement {
    ...
    @XmlElement(name = "upd_acct_invoice_line_items")
    protected List<UpdAcctInvoiceLineItemsReturnElement> updAcctInvoiceLineItems;
    ...
    public List<UpdAcctInvoiceLineItemsReturnElement> getUpdAcctInvoiceLineItems() {
        if (this.updAcctInvoiceLineItems == null) {
            this.updAcctInvoiceLineItems = new ArrayList<UpdAcctInvoiceLineItemsReturnElement>();
        }
        return this.updAcctInvoiceLineItems;
