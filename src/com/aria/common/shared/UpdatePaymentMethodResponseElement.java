...
@XmlType(name = "", propOrder = {"seqNo", "errorCode", "errorMsg", "collectionErrorCode", "collectionErrorMsg", "procCvvResponse", "procAvsResponse", "procCavvResponse", "procStatusCode", "procStatusText", "procPaymentId", "procAuthCode", "procMerchComments"})
@XmlRootElement(name = "update_payment_methodResponseElement")
public class UpdatePaymentMethodResponseElement {
