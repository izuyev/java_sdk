...
@XmlType(name = "all_invoice_line_tax_ReturnElement", propOrder = {"taxId", "amount", "beforeCreditAmount", "jurisdiction", "description", "isExcluded"})
public class AllInvoiceLineTaxReturnElement {
