 ...
 * 
 */
public class RestUtilitiesArraytoParms {
	...
	public static void setWsdlUrl(String wsdlUrl) {
		RestUtilitiesArraytoParms.wsdlUrl = wsdlUrl;
	}
	...
	public static String getFileDir() {
		if (fileDir == null)
			fileDir = "D:/JGUEVARA/Desarrollo/Aria/ArrayToParmRestUtilities.java";
		return fileDir;
	}
	...
	private static StringBuilder getMethodHeader(Node node) {
		...
		String className = buildJavaName(node.getAttributes().getNamedItem("name").getNodeValue());
		className = className.replace("Row", "Array");
		methodHeader.append("	public static void addParameterValuesFromArray(MultivaluedMap<String, String> parameters,com.aria.common.shared.");
		methodHeader.append(className);
		methodHeader.append(" arrayList) {\n");
		methodHeader.append("		if (arrayList == null) return;\n");
		methodHeader.append("		int i = 0;\n");
		return methodHeader;
	}
	...
	private static StringBuilder getMethodBody(Node node) {
		...
		String className = buildJavaName(node.getAttributes().getNamedItem("name").getNodeValue());
		methodBody.append("		for (com.aria.common.shared."+className+" row : arrayList.get"+className+"()){\n");
	...
	public void setBuildReturnElement(StringBuilder buildReturnElement) {
		RestUtilitiesArraytoParms.buildReturnElement = buildReturnElement;
	}
	/* ***************************** END - GENERAL METHODS ********************************* */
}
